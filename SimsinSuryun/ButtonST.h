#if !defined(AFX_BUTTONST_H__AD4C16A1_B86C_11D3_A635_00105A7C2F91__INCLUDED_)
#define AFX_BUTTONST_H__AD4C16A1_B86C_11D3_A635_00105A7C2F91__INCLUDED_
...
public:
	...
	void SetRoundRate( int pRate )	{ m_RoundRate = pRate; }		// 모서리 round 비율 설정 [2005-03-11-HJH(ADD)]
	void SetTextAlign( int pnTextAlign );							// [2005-07-28-HJH(ADD)] : 버튼에 그려질 Text위치 조정 
	DWORD SetBk(CDC* pDC);											//2004-0224-SHJ(ADD): [CBUTTONST]
...
protected:
	...
	int m_RoundRate;		   // 모서리 round 비율 [2005-03-11-HJH(ADD)]
	int	m_nTextAlign;				// [2005-07-28-HJH(ADD)] : 버튼 Text Align 위치 
};
...
#endif // !defined(AFX_BUTTONST_H__AD4C16A1_B86C_11D3_A635_00105A7C2F91__INCLUDED_)
